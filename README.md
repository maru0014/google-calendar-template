...
[![Version](https://img.shields.io/badge/version-0.4.0-blue)](https://github.com/maru0014/google-calendar-template/releases)
...
- ✅ 予定テンプレートの作成・編集・削除
- ✅ D&Dによるテンプレートの並び替え
- ✅ 設定内容（カレンダー / 場所 / ゲスト数 / 期間）をバッジで可視化
- ✅ 編集モーダルで変数をクリック挿入・期間クイック入力（15/30/60/90分）
- ✅ ローカルストレージに保存
...
- ✅ ダークモード対応（ポップアップはOS設定、カレンダー内UIはカレンダーのテーマに追従）
...
### インポート/エクスポート 💾
- ✅ テンプレートのバックアップ（JSON）
- ✅ JSON形式での共有（`calendarName` フィールド対応）
- 他のユーザーとのテンプレート共有
